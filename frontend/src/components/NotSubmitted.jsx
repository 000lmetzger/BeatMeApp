...
function NotSubmitted( {error, successMessage, file, cameraInputRef, fileInputRef, handleFileChange, openCamera, buttonStyle, openFileBrowser, outlineButtonStyle, loading}){
    return (
