...
function Ranking() {
    ...
    if (isLoading) {
        return (
            <div className="px-4 sm:px-6 pb-28 overflow-y-auto max-w-2xl mx-auto">
                <div className="rounded-3xl p-[2px] bg-gradient-to-r from-[#5b21b6] via-[#7c3aed] to-[#a855f7] mt-6">
                    <Card className="rounded-[22px] shadow-2xl shadow-black/10 border-0 bg-gradient-to-br from-white/95 to-white/80 backdrop-blur-xl">
    ...
    if (error) {
        return (
            <div className="px-4 sm:px-6 pb-28 overflow-y-auto max-w-2xl mx-auto">
                <div className="rounded-3xl p-[2px] bg-gradient-to-r from-[#5b21b6] via-[#7c3aed] to-[#a855f7] mt-6">
                    <Card className="rounded-[22px] border-red-200 bg-red-50/80 backdrop-blur-sm">
    ...
    const sortedScores = scores ? Object.entries(scores).sort(([, a], [, b]) => b - a) : [];

    return (
        <div className="px-4 sm:px-6 pb-28 overflow-y-auto max-w-2xl mx-auto">
            <div className="rounded-3xl p-[2px] bg-gradient-to-r from-[#5b21b6] via-[#7c3aed] to-[#a855f7] mt-6">
                <Card className="rounded-[22px] shadow-2xl shadow-black/10 border-0 bg-gradient-to-br from-white/95 to-white/80 backdrop-blur-xl overflow-hidden">
